# WUBBLE LUBBLE GUPLE BUBBLE INC
 [![License: CC BY-NC 4.0](https://img.shields.io/badge/License-CC_BY--NC_4.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc/4.0/)

## NOW HIRING: SENIOR FUN-TASTICAL WORKER OF GOOF

**GET THE JOB. EARN 1,000,000 D-BUCKS (DOUG BUCKS) PER FLOOGLE.**

An Oompa Loompa in an unnecessarily enormous tie slides a hiring packet across a desk that squeaks in B-flat. This is **Director Plonko Fizzlebottom**, your prospective employer at **WUBBLE LUBBLE GUPLE BUBBLE INC**, the City of Goof's premier supplier of municipal wubble, industrial lubble, and rigorously inspected gup.

> "APPLICANT! The City of Goof's Great Gup Engine has developed a suspicious wobble. I need a fun-tastical worker who can investigate its innards, run a controlled safety drill, and bring me receipts. Get this job and I shall pay you ONE MILLION DOUG BUCKS PER FLOOGLE. Doug has already sharpened his pencil."

| Your extremely official offer | The particulars |
| --- | --- |
| Employer | Director Plonko Fizzlebottom, Oompa Loompa, WUBBLE LUBBLE GUPLE BUBBLE INC. |
| Position | Fun-tastical Worker, Department of Suspicious Wobbling. |
| Workplace | The City of Goof, Silly Land. |
| Pay if you get the job | **1,000,000 D-Bucks (Doug Bucks) per floogle.** |
| A floogle | A unit of Silly Land time, recorded by the payroll flooglometer. |
| Your assignment | Make the City of Goof as fun-tastically-safe as possible. |

Doug Bucks and floogles belong to the company story. The job's calendar dates, hardware clock cycles, and scoring points keep their stated units. Accounting has been forbidden from converting megahertz into lunch breaks.

**[APPLY FOR THE JOB](https://forms.gle/U9jf9WYuRjpdJjvZ7)** | **[OPEN YOUR GUP ENGINE TRYOUT](qualifier/README.md)**

## The Great Gup Engine Has Wobbled
...
> Wubble the workbench and lubble the log,<br>
> Gup every glitch in the municipal cog.<br>
> Bubble the proof till the waveforms agree,<br>
> A million per floogle! Now bring them to me!

<a id="table-of-contents"></a>

## The Filing Cabinet That Goes HONK

- [The Oompa Loompa's Employee Handbook](#general-guidelines)
  - [The Floogle Calendar](#timeline)
  - [Recruit Your Wubble Crew](#teams)
  - [The Breakroom Megaphone](#communication)
  - [The Artificial Imagination Department](#ai-usage)
...
## The Oompa Loompa's Employee Handbook

Director Fizzlebottom has stamped this handbook **EXTREMELY EMPLOYMENT**. Each stamp made a different noise. The following rules determine whether your crew's work is eligible for inspection.

<a id="timeline"></a>

### The Floogle Calendar

The payroll flooglometer is currently full of custard, so the 2026 schedule uses ordinary calendar dates. Pin these to your lunchbox:

- 18 September: First tryout opens (preliminary phase launch).
- 02 October: First tryout packets due (preliminary submission deadline).
- 04 October: Shortlisted crews notified (finalists selected).
- 12 November: Grand Goof-Off work order released on site (final phase).
- 14 November: Grand Goof-Off submissions and presentations due.
- 15 November: Winning crews announced. The ceremonial desk squeaks.

*Note: There is no registration deadline. Teams can register and submit up until the preliminary phase submission deadline.*

<a id="teams"></a>

### Recruit Your Wubble Crew

Human Resources has renamed itself **Human Re-sauces**. Its eligibility rules still require:
...
Director Fizzlebottom is your story's employer. Your team still needs its own advisor; an Oompa Loompa with a hiring stamp does not fill that slot.

<a id="communication"></a>

### The Breakroom Megaphone

Most announcements for this and future work orders arrive through the [existing Discord server](https://discord.gg/KEVbWs6BPU). The breakroom megaphone is decorative; the Discord link is where your crew should check for updates.
...
## The Department of Proper Credit
...
**THE FLOOGLOMETER IS FLOOGLING. DOUG IS COUNTING. [GO GET THAT JOB.](qualifier/README.md)**
